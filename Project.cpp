...
void Menu::setChoice()
{
	...
	void display_receipt (Menu M) //FRIEND FUNCTION ACCEPTING OBJECT 
	{
		cout << "\n==========================================="<<endl;
		cout << "===PAYMENT==="<<endl;
		cout << "Item\t\t: "<< M.selection<<endl; //OBJECT FROM PRIVATE 
		cout << "Total Price\t: RM "<<fixed<<setprecision(2) <<M.price *M.number <<endl; //OBJECT FROM PRIVATE
	...
	//DO YOU WANT TO ADD MORE?? (DO WHILE LOOP + Array)
